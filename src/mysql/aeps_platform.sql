CREATE DATABASE  IF NOT EXISTS `aeps_2_0` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `aeps_2_0`;
...
CREATE TABLE `con_countries` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table has the list of countries';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table has the list of municipalities - administrative level 3';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table has the list of states - administrative level 2';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table has the information about farms';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table has the information about farms plots';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table has the history about production events in';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table has the forms answers of each production event for question with the date values';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table has the forms answers of each production event for question with the numeric values';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table has the forms answers of each production event for question with the unique or multiple type';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table has the forms answers of each production event for question with the text values';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `soc_associations` (
  ...
  `updated` datetime NOT NULL COMMENT 'date when it was updated',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table has the information about associations';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='This table has the information about people. It has personal information about farmers and technical assistans';
/*!40101 SET character_set_client = @saved_cs_client */;
